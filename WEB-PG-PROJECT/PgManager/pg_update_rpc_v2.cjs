...
BEGIN
    ...
    FOR r_tenant IN (
        ...
        WHILE v_next_invoice_date <= CURRENT_DATE LOOP
            ...
            v_is_first_invoice := FALSE; -- Only the first iteration of the while loop for a new tenant is "First"
        END LOOP;
    END LOOP;

    -- Logging (ignore unique constraint conflicts for logs if multiple calls happen)
...
;
    ...
    console.log("RPC updated with first-time logic.");
